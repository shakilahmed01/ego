...
<div class="container">
    ...
    <h1 class="text-center" style="font-size: 5rem">Collections</h1>
    ...
    <div class="row align-items-center" style="background: #f5f5f5;">
        <div class="col-md-8">
            <img src="https://www.desiolens.com/media/wysiwyg/TC_box.jpg" class="img-fluid" alt="Timeless Collection">
        </div>
        <div class="col-md-4">
            <div class="p-5 mt-2">
