        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-icon ">
                    ...
                    <div id="my_logo">
                        ...
                        <img src="{{ getImage(getFilePath('logoIcon') . '/logo.png') }}" width="50px" height="50px"
                            id="my_logo_image">

                    </div>
                </div>
                <div class="sidebar-brand-text mx-3"> EgoAdmin <sup><i class="fas fa-laugh-wink"></i></sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('baseCurve.index') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Base Curve</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('lensDesign.index') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Lens Design</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('diameter.index') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Diameter</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('replacement.index') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Replacement</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('tone.index') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Tones</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('water_content.index') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Water Content</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('admin.users.active') }}"><i
                                class="menu-icon fa fa-dot-circle">Active User</i></a>
                        <a class="collapse-item" href="{{ route('admin.users.banned') }}"><i
                                class="menu-icon fa fa-dot-circle">Banned User</i>
                            @if ($bannedUsersCount)
                            <span class="bg-danger">{{ $bannedUsersCount }}</span>
                            @endif
                        </a>
                        <a class="collapse-item" href="{{ route('admin.users.email.unverified') }}"><i
                                class="menu-icon fa fa-dot-circle">Email Unverified</i>
                            @if ($emailUnverifiedUsersCount)
                            <span class="bg-danger">{{ $emailUnverifiedUsersCount }}</span>
                            @endif
                        </a>
                        <a class="collapse-item" href="{{ route('admin.users.mobile.unverified') }}"><i
                                class="menu-icon fa fa-dot-circle">Mobile Unverified</i>
                            @if ($mobileUnverifiedUsersCount)
                            <span class="bg-danger">{{ $mobileUnverifiedUsersCount }}</span>
                            @endif
                        </a>
                        <a class="collapse-item" href="{{ route('admin.users.kyc.unverified') }}"><i
                                class="menu-icon fa fa-dot-circle">KYC Unverified</i>
                            @if ($kycUnverifiedUsersCount)
                            <span class="bg-danger">{{ $kycUnverifiedUsersCount }}</span>
                            @endif
                        </a>
                        <a class="collapse-item" href="{{ route('admin.users.with.balance') }}"><i
                                class="menu-icon fa fa-dot-circle">With Balance</i></a>
                        <a class="collapse-item" href="{{ route('admin.users.all') }}"><i
                                class="menu-icon fa fa-dot-circle">All User</i></a>
                        <a class="collapse-item" href="{{ route('admin.users.notification.all') }}"><i
                                class="menu-icon fa fa-dot-circle">Notification to all</i></a>
                    </div>
                </div>
            </li>
            <!-- Heading -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed " href="javascript:void(0)" data-toggle="collapse"
                    data-target="#collapse-notification" aria-expanded="true" aria-controls="collapse-notification">
                    <i class="fas fa-bell"></i>
                    <span>@lang('Notification Setting')</span>
                </a>
                <div id="collapse-notification" class="collapse" aria-labelledby="heading-notification"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
